...
logistics_dir = '/home/ruanf/ZEPH/Z.CORE/src/pages/logistics'
files = glob.glob(os.path.join(logistics_dir, '*.jsx'))
...
for file_path in files:
    ...
    # 6. Title spans for PageContainer (specific to logistics modules based on typical names)
    titles_to_executive = [
        "Gestão de Frotas",
        "Agenda de Entregas",
        "Gestão de Depósito",
        "Agendamento de Transportadoras",
        "Treinamento de Depósito"
    ]
...
print("Logistics mobbin script complete.")
