    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--bg-card)', fontFamily: 'var(--font-main)' }}>
            ...
            <div style={{ padding: '30px', maxWidth: '1200px', margin: '0 auto' }}>
                <h2 style={{ color: '#2c3e50', marginBottom: 'var(--space-4)', borderBottom: '2px solid #0288d1', paddingBottom: '10px', display: 'inline-block' }}>
                    Treinamentos
                </h2>
                ...
                <div style={{ background: 'var(--bg-card)', padding: 'var(--space-5)', borderRadius: 'var(--space-4)', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
                    ...
                    <p style={{ color: 'var(--text-muted)' }}>
                        ...
                        Capacitação da Equipe para a unidade <strong>{activeUnit === 'madville' ? 'Madville' : 'Curitiba'}</strong>.
                    </p>
                </div>
            </div>
        </div>
...
export default WarehouseTraining;