    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f5f7fa', fontFamily: '"Segoe UI", sans-serif' }}>
            ...
            <div style={{ padding: '30px', maxWidth: '1200px', margin: '0 auto' }}>
                <h2 style={{ color: '#2c3e50', marginBottom: '20px', borderBottom: '2px solid #283593', paddingBottom: '10px', display: 'inline-block' }}>
                ...
                <div style={{ background: 'white', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
                    ...
                    <p style={{ color: '#666' }}>
                        Módulo de Gerenciamento de Equipamentos em desenvolvimento.
                        Controle de Hardware/Software para a unidade <strong>{activeUnit === 'madville' ? 'Madville' : 'Curitiba'}</strong>.
                    </p>
                </div>
            </div>
        </div>
