        ...
        <div style={{
            ...
            <div style={{
                ...
                <div>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '14px', marginTop: '4px' }}>Inteligência de Vendas e Predição de Performance</p>
                </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ display: 'flex', gap: '10px' }}>
                                            <button
                                                ...
                                                style={{
                                                    flex: 1, padding: '12px', backgroundColor: '#25D366', color: '#fff', border: 'none', borderRadius: '10px', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', transition: '0.2s', boxShadow: '0 2px 5px rgba(37, 211, 102, 0.3)'
                                                }}
                                            >
                                            ...
                                            <button style={{ flex: 1, padding: '12px', backgroundColor: 'var(--bg-input)', color: 'var(--text-main)', border: '1px solid var(--border-color)', borderRadius: '10px', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '25px' }}>
                                ...
                                <div style={{
                                    ...
                                    borderRadius: '16px',
                                    boxShadow: 'var(--shadow-lg)',
                                    border: `1px solid ${selectedClient.churnRisk === 'ALTO' ? '#ef9a9a' : 'var(--border-color)'}`,
                                    display: 'flex',
