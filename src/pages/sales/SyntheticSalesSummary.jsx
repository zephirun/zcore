        ...
        <div style={{ minHeight: '100vh', background: '#f5f7fa', fontFamily: 'var(--font-main)' }}>
            ...
            <div style={{ padding: '30px', maxWidth: '1200px', margin: '0 auto' }}>
                ...
                <div style={{ background: 'white', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
                    ...
                    <p style={{ color: '#666' }}>
                        Módulo de Resumo Sintético de Vendas em desenvolvimento.
                        Aqui será exibida a visão geral e KPIs de vendas para a unidade <strong>{activeUnit === 'madville' ? 'Madville' : 'Curitiba'}</strong>.
                    </p>
                </div>
            </div>
        </div>
