    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f5f7fa', fontFamily: 'var(--font-main)' }}>
            ...
            <div style={{ padding: '30px', maxWidth: '1200px', margin: '0 auto' }}>
                <h2 style={{ color: '#2c3e50', marginBottom: '20px', borderBottom: '2px solid #f57c00', paddingBottom: '10px', display: 'inline-block' }}>
                    Tratativas Fornecedores
                </h2>
                ...
                <div style={{ background: 'white', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
                    ...
                    <p style={{ color: '#666' }}>
                        Módulo de Tratativas Fornecedores em desenvolvimento.
                        Resolução de Conflitos para a unidade <strong>{activeUnit === 'madville' ? 'Madville' : 'Curitiba'}</strong>.
                    </p>
                </div>
            </div>
        </div>
